        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto">
              ...
              <li class="nav-item active"><a class="nav-link" href="<?php echo base_url('index.php/c_pusat/load_contact'); ?>">Contact</a></li>
...
<footer class="footer-area">
  ...
  <!-- contact js -->
  <script src="http://localhost/pro/assets/js/jquery.form.js"></script>
  <script src="http://localhost/pro/assets/js/jquery.validate.min.js"></script>
  <script src="http://localhost/pro/assets/js/contact.js"></script>
  <!--gmaps Js-->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
  <script src="http://localhost/pro/assets/js/gmaps.min.js"></script>
