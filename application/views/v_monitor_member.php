    ...
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticModalLabel">Hapus Member</h5>
        ...
        <div class="modal-body">
          <p>
            Apakah anda yakin menghapus member ini?
          </p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
          <button type="button" class="btn btn-danger" onclick="window.location.href='<?php echo base_url('index.php/c_admin/hapus_member/'.$u->ID_USER); ?>'">Confirm</button>
        </div>
      </div>
    </div>
  </div>
                            ...
                            <div class="container-fluid">
                              <div class="header-wrap">
                                ...
                                <div class="header-button">
                                  ...
                                  <?php
                                  foreach($data_user_adm as $u_data){
                                    ?>
                                                  ...
                                                  <tbody>
                                                    ...
                                                    foreach($data_user as $u){
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td>
                                                          <div class="image img-cir img-40">
                                                            <img src="http://localhost/pro/assets/uploads/<?=$u->FOTO_USER?>" alt="" />
                                                          </div>
                                                        </td>
                                                        <td>
                                                          <div class="table-data__info">
                                                            <h6><?php echo $u->NAMA_USER ?></h6>
                                                            <span>
                                                        ...
                                                        <td>
                                                          <span class="more">
                                                            <i class="zmdi zmdi-delete" data-toggle="modal" data-target="#staticModal"></i>
                                                          </span>
                                                        </td>
                                                      </tr>
                                                    <?php } ?>
