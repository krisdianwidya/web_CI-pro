    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content text-center">
          ...
          <div class="page_link">
            <a href="<?php echo base_url('index.php/c_pusat'); ?>">Home</a>
        ...
        <div class="col-lg-6">
          <div class="login_box_img">
            ...
            <div class="hover">
              ...
              <a class="main_btn" href="<?php echo base_url('index.php/c_user/tambah'); ?>">Create an Account</a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="login_form_inner">
            ...
            <form class="row login_form" action="<?php echo base_url('index.php/c_login/aksi_login'); ?>" method="post" id="contactForm" novalidate="novalidate">
